...
CREATE TABLE positions (
    ...
    org_id BIGINT NOT NULL COMMENT '所属三级机构ID',
...
CREATE TABLE salary_issues (
    ...
    org_id BIGINT NOT NULL COMMENT '发放机构ID',
...
CREATE TABLE salary_issue_details (
    ...
    salary_standard_id BIGINT NOT NULL,
...
SELECT '数据库已成功创建，所有ID字段均为BIGINT类型' AS '创建结果';